# The Bookshelf API Project

This project is a virtual bookshelf for the Udacity FullStack Nanodegree program. It allows you to add books to the bookshelf, give them a rating, update the rating and search through their book lists. As a part of the Fullstack Nanodegree, it serves as a practice module for lessons from Course 2: API Development and Documentation. By completing this project, students learn and apply their skills structuring and implementing well formatted API endpoints that leverage knowledge of HTTP and API development best practices. 
...
The instructions below are meant for the local setup only. Developers using this project should already have Python3, pip and node installed on their local machines.
...
## Acknowledgements 
A special shout out to Coach Caryn, The awesome team at Udacity and all of the students in the ALX Fullstack Cohort of 2022! 